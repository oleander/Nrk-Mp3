...
superfish.b = {};
        ...
        superfish.b.ip              = "193.11.221.100";
        superfish.b.userid          = "chrome0000000000";
        superfish.b.appVersion      = "5.1.3";
...
superfish.b.shareMsgProd = 'FastestChrome Similar Product Search';
superfish.b.shareMsgUrl = 'http://www.smarterfox.com/superfish';
superfish.b.suEnabled = 1;
superfish.b.partnerCustomUI = 1;
superfish.b.psuTitleColor = '#FFFFFF';
superfish.b.psuSupportedBy = 1;
superfish.b.psuSupportedByText = 'Powered by FastestChrome';
...
superfish.publisher.pushImg = function(img) {
    if(this.multiSu && this.imgs.length < superfish.b.suEnabled ){
...
superfish.publisher.send = function() {
    if (this.multiSu && this.reqCount < superfish.b.suEnabled) {
...
superfish.publisher.report = function(action) {
    ...
    superfish.b.createPSU = function(){
        if( window == top ){
            var sfb = superfish.b;
            var imUrlDef = superfish.p.site + "images/";
            ...
            return(
                "<div id='SF_SLIDE_UP' style='height:105px;width:255px;background:url(" + imURL + "bgPreSu.png) no-repeat;display:none;z-index:198900;position:" + pos + ";-moz-user-select:none;-khtml-user-select:none;user-select:none;" + mTop + ";cursor:default'>"+
                ...
                "   <input type=button style='width:116px;height:24px;position:absolute;top:6" + ( sfb.psuSupportedBy ? 5 : 9 ) + "px;left:104px;cursor:pointer;font:arial,sans-serif;font-weight:normal;font-size:13px;' onclick='superfish.b.psuGlide();' title=' Click to See More Results ' value=' Compare Prices '/>" +
                ( sfb.psuSupportedBy ?
                    "   <a style='position:absolute;top:94px;right:10px;" + fnt + "font-size:8px;color:#999999;font-style:italic;text-decoration:none;' href='" +
    ...
    superfish.b.initPSU = function( item ){
        ...
        if (su) {
            ...
            su.innerHTML = su.innerHTML.replace( "{STORE}", item.merchantName );
